            ...
            <div className="sm:text-center lg:text-left">
              <h1 className="text-2xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl lg:text-left lg:text-4xl xl:text-6xl">
                ...
                <span className=" text-white">
                  North West Regional Fund For Health Promotion (NWRFHP)
                </span>
              </h1>
              <p className="mt-3 max-w-lg mx-auto font-medium text-lg text-gray-200 sm:text-xl md:mt-5 md:max-w-2xl md:mx-0">
                The North West Regional Fund for Health Promotion PIG is a
                public corporate dialogue structure set up by a constituent
                agreement of the state, the technical/financial partners, and
                the North West community on June 11, 2012 in line with law no.
                2010/023 of December 2010 to define the status of Public
                Interest Groups in Cameroon.
              </p>
