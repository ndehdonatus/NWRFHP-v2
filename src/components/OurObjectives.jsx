      ...
      <div className="bg-white">
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
          <div>
            ...
            <h3 className="mt-2 text-2xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-2xl">
              Objectives of NWRFHP - PIG
            </h3>
            <p className="mt-4 text-lg text-gray-500">
              The main objective of the Fund is to promote quality health care
              for people in the North West Region. The Specific Objectives
